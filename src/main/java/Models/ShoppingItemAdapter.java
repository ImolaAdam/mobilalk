...
import com.example.mollykerteszete.R;
import com.example.mollykerteszete.ShopListActivity;
...
public class ShoppingItemAdapter
    ...
    // Member variables.
    private ArrayList<Product> mShoppingData;
    private ArrayList<Product> mSoppingDataAll;
    private Context mContext;
    private int lastPosition = -1;

    public ShoppingItemAdapter(Context context, ArrayList<Product> itemsData) {
    ...
    public void onBindViewHolder(ShoppingItemAdapter.ViewHolder holder, int position) {
        // Get current sport.
        Product currentItem = mShoppingData.get(position);
    ...
    private Filter shoppingFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if(charSequence == null || charSequence.length() == 0) {
                ...
                for(Product item : mSoppingDataAll) {
